...
public class MessageDeserializeFunction extends ProcessFunction<byte[], TelemetryDto> {
    ...
    @Override
    public void processElement(byte[] bytes, Context context, Collector<TelemetryDto> collector) throws Exception {
        ...
        if (messageStart.startsWith("{\"messageType\":\"Status\"")) {
            ...
            context.output(outputTag, telemetryRecord);
        }
    }
